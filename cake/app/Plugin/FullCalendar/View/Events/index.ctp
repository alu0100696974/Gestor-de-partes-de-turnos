...
<div class="events index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $event['Event']['id'])); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $event['Event']['id'])); ?>
			<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $event['Event']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Nuevo Evento', true), array('plugin' => 'full_calendar', 'action' => 'add')); ?></li>
		<li><?php echo $this->Html->link(__('Gestionar Tipos de Evento', true), array('plugin' => 'full_calendar', 'controller' => 'event_types', 'action' => 'index')); ?> </li>
