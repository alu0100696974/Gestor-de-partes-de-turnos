...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Ver', true), array('plugin' => 'full_calendar', 'controller' => 'events', 'action' => 'view', $event['id'])); ?>
				<?php echo $this->Html->link(__('Editar', true), array('plugin' => 'full_calendar', 'controller' => 'events', 'action' => 'edit', $event['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
