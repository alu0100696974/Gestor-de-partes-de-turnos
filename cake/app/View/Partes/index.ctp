...
<div class="partes index">
	...
	<tr>
		...
		<td class="actions">
		  ...
		  ?>
		  		  <?php if (($parte['Parte']['validado']==1) && ($tiporol == 2) ) {
					echo $this->Html->link(__('PDF'), array('action' => 'reporte', $parte['Parte']['id'])); 
				}
		  ?>
		  ...
		  ?>
		   <?php if (($parte['Parte']['firmado']==1) && ($parte['Parte']['validado']<>1) && ($tiporol == 2) && ($parte['Parte']['copiado']==1)) {
					echo $this->Form->postLink(('Validar'), array('action'=>'validar', $parte['Parte']['id'], $parte['Parte']['modificado'], $parte['Parte']['usuariovendedor']), array('confirm' =>'¿Seguro que quieres validar, (esta accion no se puede eliminar)?'));				
				}
		  ?>
		  <?php 
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Calendario'),array( 'controller' => 'full_calendar', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('Incidencias'),array( 'controller' => 'incidencias', 'action' => 'index')); ?> </li>
