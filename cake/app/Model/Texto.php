 ...
 */
	...
	{
		 return $datos = $this->query("SELECT * FROM `textos` WHERE `parte_id`=$idparte AND `tipocampos_tipoparte_id`=$tipo");

	}
	function obtenerlistatipos ($idparte,$workflow){
	 return $datos = $this->query("SELECT `id`,`tipocampos_tipoparte_id` FROM `textos` WHERE `parte_id`=$idparte AND `workflowpaso_id`=$workflow");
	}
	function obtenertodotipos ($idparte){
		return $datos = $this->query("SELECT `id`,`tipocampos_tipoparte_id` FROM `textos` WHERE `parte_id`=$idparte");
	}
